...
A comprehensive wedding invitation platform built with React, TypeScript, Supabase, and Tailwind CSS. Create beautiful, customizable wedding invitations with real-time RSVP tracking.
...
- Multiple sharing options (WhatsApp, Telegram, etc.)
...
4. **Supabase Storage** - Real database persistence
...
5. **Save & Share** - Public or private templates
...
- **Primary Language**: Uzbek (O'zbek tili)
- **UI Text**: Fully localized interface
- **Date Formatting**: Local date formats
- **Cultural Adaptation**: Wedding-specific terminology
...
- **Fallback Systems**: localStorage backup for offline use

## 📞 **Support Features**

- **Help Documentation**: Comprehensive FAQ
...
- **Success Celebrations**: Rewarding completion animations
