...
// Classic Template
const ClassicTemplate: React.FC<any> = ({
  template,
  invitation,
  guestName,
  formatDate,
  ...
  <div
    className="card-modern p-12 relative overflow-hidden"
    style={{
    ...
    <div className="text-center space-y-8">
      <div>
        <p
          ...
          style={{ color: template.colors.text, opacity: 0.7 }}
        >
...
const ElegantTemplate: React.FC<any> = ({
  template,
  invitation,
  guestName,
  formatDate,
...
const LuxuryTemplate: React.FC<any> = ({
  template,
  invitation,
  guestName,
  formatDate,
...
const RusticTemplate: React.FC<any> = ({
  template,
  invitation,
  guestName,
  formatDate,
...
const DefaultTemplate: React.FC<any> = ({ invitation, guestName }) => (
  <div className="card-modern p-12 text-center">
    ...
    {guestName && (
      <p className="mt-4 text-lg font-medium">Hurmatli {guestName}</p>
    )}
  </div>
);
