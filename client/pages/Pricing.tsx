...
export default function Pricing() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'RSVP javoblarini kuzatib boring va mehmon ro\'yxatini boshqaring'
    },
    {
      icon: Share2,
      title: 'Oson ulashish',
  ...
  const testimonials = [
    {
      ...
      date: '2024 yil mart',
      comment: 'TaklifNoma orqali ajoyib taklifnoma yaratdik. Barcha mehmonlar dizaynni juda yoqtirishdi!',
      rating: 5
    },
    {
      ...
      date: '2024 yil aprel',
      comment: 'RSVP funksiyasi juda foydali bo\'ldi. Mehmonlar javoblarini osongina kuzatib bordim.',
      rating: 5
    },
    {
      name: 'Madina Aliyeva',
      ...
      date: '2024 yil may',
      comment: 'Premium rejada juda ko\'p chiroyli shablonlar bor. Hech qayerdan bunday xizmat topa olmadim.',
      rating: 5
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Bepul rejada 3 ta taklifnoma yarata olasiz. Agar ko\'proq kerak bo\'lsa, Premium yoki Biznes rejasini tanlashingiz mumkin.'
    },
    {
      question: 'Taklifnomamni qanday ulasha olaman?',
      answer: 'Taklifnomani WhatsApp, Telegram, Facebook orqali ulashish, QR kod yaratish yoki havolani nusxalash mumkin.'
    },
    {
      question: 'Mehmonlar qanday javob berishlari mumkin?',
      answer: 'Mehmonlar taklifnomadagi RSVP tugmasi orqali "Kelaman" yoki "Kela olmayman" deb javob berishlari mumkin.'
    },
    {
      question: 'To\'lovni qanday amalga oshiraman?',
      answer: 'To\'lovni Click, Payme, UzCard orqali xavfsiz tarzda amalga oshirishingiz mumkin.'
    },
    {
      question: 'Taklifnomamni tahrirlash mumkinmi?',
      answer: 'Ha, yaratganingizdan keyin istalgan vaqtda taklifnomani tahrirlash mumkin.'
    },
    {
      question: 'Texnik yordam qanday olaman?',
      answer: 'Telegram kanalimiz @taklifnoma_support orqali yoki email: support@taklifnoma.uz ga murojaat qilishingiz mumkin.'
    }
  ];
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Professional taklifnomalar yaratish uchun eng yaxshi narxlar. Bepul rejadan boshlab, Premium imkoniyatlargacha.
          </p>
            ...
            return (
              ...
              >
                ...
                <div className="text-center mb-6">
                  <div className={`w-12 h-12 ${plan.color} rounded-xl flex items-center justify-center mb-4 mx-auto`}>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Professional taklifnomalar yaratish uchun barcha kerakli vositalar bir joyda
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Minglab couple'lar TaklifNoma orqali muvaffaqiyatli to'ylarini o'tkazdilar
            </p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="card-modern p-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{testimonial.wedding}</p>
        ...
        <div className="text-center bg-gradient-to-r from-primary to-purple-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Bir necha daqiqada professional taklifnoma yarating va sevimli odamlaringizni taklif qiling.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" asChild className="px-8 py-4 text-lg rounded-xl">
              <Link to="/register">
                Bepul Boshlash
                <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="px-8 py-4 text-lg rounded-xl border-white text-white hover:bg-white hover:text-primary">
              <Link to="/templates">
